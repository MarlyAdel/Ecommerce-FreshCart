      ...
      <div className="w-1/2 my-4 mx-auto h-full">
        {successMessage ? (
          ...
          <form onSubmit={shippingForm.handleSubmit}>
            <h1 className="text-4xl my-12 text-gray-800 font-medium">
            ...
            <div className="relative z-0 w-full mb-5 group">
              ...
              <label
                ...
                className="peer-focus:font-medium absolute text-xl text-gray-500 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:text-main"
              >
                Details:
              </label>
            ...
            {isCallingAPI ? (
              ...
              <button
                type="submit"
                className="text-white block ms-auto bg-main hover:bg-main hover:opacity-90 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
              >
                Pay now
              </button>
            )}
